...
# data
dataset = 'openwebtext'
train_file = 'train.bin'  # ← NEU: Dateiname des Trainingssets (für Scaling-Experimente)
                           #   Überschreibbar via --train_file=train_10.bin etc.
...
if init_from == 'resume':
    if checkpoint.get('optimizer') and isinstance(checkpoint['optimizer'], dict) and 'param_groups' in checkpoint['optimizer']:
